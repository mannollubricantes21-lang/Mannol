// =====================================================
// UI helpers — toasts, modals, icons (inline SVG), escapeHtml
// =====================================================

// ===== XSS prevention — escape HTML entities in user-provided strings =====
...
// Convenience: escape multiple fields at once
export function esc(obj) {
...
// ===== Modal (with stacking support for nested modals) =====
// Each modal is identified by a unique ID; selectors are scoped to that modal's overlay element.
let _modalCounter = 0;

export function showModal({ title, body, footer, onClose, size }) {
  ...
  overlay.innerHTML = `
    <div class="modal" role="dialog" aria-modal="true" aria-labelledby="${modalId}-title" style="${size === 'lg' ? 'max-width: 42rem;' : ''}">
  ...
  // Cerrar con tecla Escape (solo el último modal abierto)
  const escHandler = (e) => {
    if (e.key === "Escape") {
  ...
  // Focus trap: enfocar el primer elemento interactivo del modal
  setTimeout(() => {
    const focusable = overlay.querySelector("input, button:not(.modal-close), select, textarea");
...
// ===== Confirm dialog (fixed: scoped selectors don't break with nesting) =====
export function confirmDialog(message, onConfirm, onCancel) {
  const close = showModal({
    ...
    footer: `
      ...
      <button class="btn btn-danger modal-confirm" type="button">Confirmar</button>
    `,
    onClose: () => { if (onCancel) onCancel(); },
  });
  // Scope selectors to the last opened modal (this one)
...
export const icons = {
  store: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m2 7 4.41-4.41A2 2 0 0 1 7.83 2h8.34a2 2 0 0 1 1.42.59L22 7l-3 3v11a1 1 0 0 1-1 1H6a1 1 0 0 1-1-1V10L2 7Z"/><path d="M6 10v11"/><path d="M18 10v11"/><path d="M2 7h20"/></svg>`,
  cart: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="8" cy="21" r="1"/><circle cx="19" cy="21" r="1"/><path d="M2.05 2.05h2l2.66 12.42a2 2 0 0 0 2 1.58h9.78a2 2 0 0 0 1.95-1.57l1.65-7.43H5.12"/></svg>`,
  boxes: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2.97 12.92A2 2 0 0 0 2 14.63a3.8 3.8 0 0 0 2 3.5l5.32 3a4 4 0 0 0 3.36 0L22 14.63a2 2 0 0 0-2.63-2.92L13.36 15a4 4 0 0 1-3.36 0Z"/><path d="m22 9.93-7.58 4.36a4 4 0 0 1-3.36 0L2 9.93a2 2 0 0 1 0-3.5l5.32-3a4 4 0 0 1 3.36 0l5.32 3a4 4 0 0 0 3.36 0Z"/></svg>`,
  ...
  euro: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 10h12"/><path d="M4 14h9"/><path d="M19 6a7.7 7.7 0 0 0-5.2-2A7.9 7.9 0 0 0 6 12c0 4.4 3.5 8 7.8 8 2 0 3.8-.8 5.2-2"/></svg>`,
  ...
  arrowUp: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 19V5"/><path d="m5 12 7-7 7 7"/></svg>`,
  ...
  printer: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2"/><path d="M6 14h12v8H6z"/><path d="M6 9V2h12v7"/></svg>`,
  listTree: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 12H8"/><path d="M21 6H8"/><path d="M21 18H8"/><path d="M3 6v4"/><path d="M3 14v4"/><path d="M3 10h4"/><path d="M3 18h4"/></svg>`,
